...
#define PRODUCT_DETAIL_SEGURE_ID @"segueProductDetail"
...
- (void)viewDidLoad
{
    ...
    allProducts = [[ProductDatabase database] getAllProducts];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = p.category;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self performSegueWithIdentifier:PRODUCT_DETAIL_SEGURE_ID sender:p];
...
{
    if ([segue.identifier isEqualToString:PRODUCT_DETAIL_SEGURE_ID]) {
        ProductDetailViewController* dvc = [segue destinationViewController];
        [dvc setProduct:(Product*)sender];
    }
}
@end
